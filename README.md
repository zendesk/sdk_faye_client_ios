...
acknowledge that such terms govern Your use of and access to the ZendeskSDKFayeClient SDK.

If You make any Contributions (defined below) to the ZendeskSDKFayeClient SDK, 
